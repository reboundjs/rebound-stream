...
Cache.prototype.group = function(cid){
    ...
    this.groups.count = BigInt(2).pow(cid);
...
Cache.prototype.contains = function contains(cid){
  ...
  // console.log('MIN', this.level.min.toString())
  // console.log('SIZE', this.groups.size.toString())
...
Cache.prototype.add = function add(cid){
  ...
  // All intermediate levels are set to falsy values
    ...
    var groupSize = BigInt.pow(2, cid).div(this.level.count);
